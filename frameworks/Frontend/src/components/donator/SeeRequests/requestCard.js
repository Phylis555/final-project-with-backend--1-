...
export default function RequestCard(props) {
  ...
  return (
    <>
      ...
      <div
        className=" course card d-flex " style={{ width: 500, height: "92%",maxHeight:500,marginBottom: 20,marginRight: 20,}}>
        <div className="card-body ">
          ...
          {props.accepted === 'accepted' ? (
            <div className="d-flex justify-content-around" style={{marginTop: 20,}}></div>
          ) : (
