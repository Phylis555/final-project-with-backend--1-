                      ...
                      <div class="d-flex justify-content-between" style={{ marginTop: 10 }}>
                        ...
                        {loading ? (
                          ...
                          <>
                            ...
                            >
                              <div class="input-group mb-3 input-group input-group-outline mb-3" dir="rtl">
                                <input
                    ...
                    <div className="tab-pane show active fade" id="profile" role="tabpanel" aria-labelledby="contact-tab">
                      <div class="d-flex justify-content-between  kgcard" style={{ marginTop: 10 }}>
                          {donations.length === 0 ? (
                              ...
                              <>
                                  <button class="btn btn-danger" onClick={() => generateCompletedReport(donations)}>
                                      יצירת דוח
                                  </button>
                                  <div class="head1" style={{ marginRight: "555px", width: 400 }}>
                                      ...
                                      <div className="course">
                                          <div className="course-info">
                                            <div class="progress-container">
                                              ...
                                              <span onClick={() => deleteDonation(f._id)} style={{ cursor: "pointer" }}>
                                                מחק
                                              </span><br/>
                                          ...
                                          <div className="d-flex justify-content-around">
                                            ...
                                            <div>
                                              ...
                                              <Link
                                                to={{
                                                  pathname: "/donator/viewRequest/" + f._id,
                                                  state: { fromAccepted: false },
                                                }}
                                              >
                                                <span className="seereq"> ראה בקשות</span>
                                              </Link>
                                            </div>
                                            <div>
                                              <svg
