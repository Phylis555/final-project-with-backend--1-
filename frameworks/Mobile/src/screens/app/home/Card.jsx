...
import { Image, TouchableOpacity, Text, View, StyleSheet,Pressable} from 'react-native';
import React from 'react';
import { SimpleLineIcons } from '@expo/vector-icons';
import Colors from '../../../utils/colors';
import { useNavigation } from '@react-navigation/native';
        ...
        <View style={{ flexDirection: "row" }}>
          ...
          >
            <View>
              <Text
                numberOfLines={1}
                style={{ fontSize: 18, fontFamily: "Outfit_600SemiBold", textAlign:'right' }}
              >
            ...
            >
              <View style={{}}>
                <View style={{ flexDirection: "row-reverse", flex:1 ,margin:3}}>
                <SimpleLineIcons name="location-pin" size={18} color={Colors.primary} />

                  <Text
                    style={{ color: "gray", fontFamily: "Outfit_400Regular"  }}  numberOfLines={1} ellipsizeMode="tail">
                    {" "}
                    {details?.location}
                  </Text>
                ...
                <View style={{flexDirection: 'row-reverse', flex:1 ,margin:3}}>
                    ...
                    <Text style={ { color: Colors.primary, fontFamily: "Outfit_400Regular"  }} numberOfLines={1} ellipsizeMode="tail"> {" "}
                  נותרו {getRemainingTime(details.donationEndDate)}</Text>
                </View>
                <Text
                  style={{ color: "gray", fontFamily: "Outfit_400Regular" , textAlign: 'right', fontSize:10}}
                >
                  {" "}
