  ...
  onSortSelect = (sortBy) => {
    ...
    switch (sortBy) {
      ...
      case "oldestCreatedDate":
        dataToSort.sort(
          (a, b) =>
            new Date(b.donationStartDate) - new Date(a.donationStartDate)
        );
        break;
      case "newestCreatedDate":
        dataToSort.sort(
          (a, b) =>
            new Date(a.donationStartDate) - new Date(b.donationStartDate)
        );
        break;
      case "popularity":
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <FlatList
          data={activeCategory == "הכל" ? dataSource : filteredData}
          style={{ marginTop: 15 }}
