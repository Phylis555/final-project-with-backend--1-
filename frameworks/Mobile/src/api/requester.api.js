...
export const updateProfile = (userId, user,token) => API.post(`/updateProfile/${userId}`, user, getAuthHeader(token));
export const updatePassword = (userId, user ,token) => API.post(`/updatePassword/${userId}`, user,getAuthHeader(token));
