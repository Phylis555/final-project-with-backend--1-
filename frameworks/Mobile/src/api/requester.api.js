...
export const getOneRequest = (requestId) =>
  API.get(`/view/request/${requestId}`);
export const requesterProfile = (requestId, token) =>
  API.get(`/profile/${requestId}`, getAuthHeader(token));
export const updateProfile = (userId, user, token) =>
  API.post(`/updateProfile/${userId}`, user, getAuthHeader(token));
export const updatePassword = (userId, user, token) =>
  API.post(`/updatePassword/${userId}`, user, getAuthHeader(token));
export const myRequests = (userId) => API.get(`/my/requests/${userId}`);
export const removeRequest = (requestId) =>
  API.delete(`/delete/${requestId}`, getAuthHeader());
