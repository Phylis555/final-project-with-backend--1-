...
const {
  getAllOrganizations,
} = require("../controllers/organization/allOrganizations");
const {
  updateOrganization,
  changePassword,
  updateOrganizationBoard,
} = require("../controllers/organization/updateOrganization");
const {
  getOrganization,
} = require("../controllers/organization/getOrganization");
const {
  deleteOrganization,
} = require("../controllers/organization/deleteOrganization");
const {
  getNContributions,
} = require("../controllers/organization/summary/latestContributions");
const {
  getDashboardSummary,
} = require("../controllers/organization/summary/dashboardSummary");
const {
  contributionChart,
} = require("../controllers/organization/summary/contributionChart");
const {
  generateReport,
} = require("../controllers/organization/summary/generateReport");
