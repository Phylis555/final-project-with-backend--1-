...
} = require("../../controllers/admin/requestedOrganization");
const {
  getApprovedOrganizations,
} = require("../../controllers/admin/approvedOrganization");
const {
  deleteReqOrganization,
} = require("../../controllers/admin/deleteReqOrg");
const {
  getOneOrganizationDetails,
} = require("../../controllers/admin/oneOrganizationiDetails");
...
} = require("../../controllers/admin/updateDonationStatus");
const {
  getAllPendingDonations,
} = require("../../controllers/admin/pendingDonationList");
const { getAllUsers } = require("../../controllers/admin/getAllUsers");
const {
  getAllAcceptedDonations,
} = require("../../controllers/admin/acceptedDonationList");
const {
  editOrganizationStatus,
} = require("../../controllers/admin/updateOrgStatus");
const {
  updateFundStatus,
} = require("../../controllers/admin/updateFundStatus");
const {
  deleteDonationRequest,
} = require("../../controllers/admin/deleteDonationRequest");
